...
//			{ARM_SYSREG_CPSR_F, "sysreg_cpsr_f"},
			...
			{ARM_SYSREG_MSPLIM, "sysreg_msplim"},
			{ARM_SYSREG_PSPLIM, "sysreg_psplim"},
			{ARM_SYSREG_MSP_NS, "sysreg_msp_ns"},
			{ARM_SYSREG_PSP_NS, "sysreg_psp_ns"},
			{ARM_SYSREG_MSPLIM_NS, "sysreg_msplim_ns"},
			{ARM_SYSREG_PSPLIM_NS, "sysreg_psplim_ns"},
			{ARM_SYSREG_PRIMASK_NS, "sysreg_primask_ns"},
			{ARM_SYSREG_BASEPRI_NS, "sysreg_basepri_ns"},
			{ARM_SYSREG_FAULTMASK_NS, "sysreg_faultmask_ns"},
			{ARM_SYSREG_CONTROL_NS, "sysreg_control_ns"},
			{ARM_SYSREG_SP_NS, "sysreg_sp_ns"},
...
//			{ARM_SYSREG_CPSR_F, i1},
			...
			{ARM_SYSREG_MSPLIM, defTy},
			{ARM_SYSREG_PSPLIM, defTy},
			{ARM_SYSREG_MSP_NS, defTy},
			{ARM_SYSREG_PSP_NS, defTy},
			{ARM_SYSREG_MSPLIM_NS, defTy},
			{ARM_SYSREG_PSPLIM_NS, defTy},
			{ARM_SYSREG_PRIMASK_NS, defTy},
			{ARM_SYSREG_BASEPRI_NS, defTy},
			{ARM_SYSREG_FAULTMASK_NS, defTy},
			{ARM_SYSREG_CONTROL_NS, defTy},
			{ARM_SYSREG_SP_NS, defTy},
...
Capstone2LlvmIrTranslatorArm_impl::_i2fm =
{
		...
		{ARM_INS_ESB, nullptr},
		{ARM_INS_FADDD, nullptr},
		{ARM_INS_FADDS, nullptr},
		{ARM_INS_FCMPZD, nullptr},
		{ARM_INS_FCMPZS, nullptr},
		{ARM_INS_FCONSTD, nullptr},
		{ARM_INS_FCONSTS, nullptr},
		{ARM_INS_FMDHR, nullptr},
		{ARM_INS_FMDLR, nullptr},
		{ARM_INS_FMSTAT, nullptr},
		{ARM_INS_FSUBD, nullptr},
		{ARM_INS_FSUBS, nullptr},
		...
		{ARM_INS_HINT, &Capstone2LlvmIrTranslatorArm_impl::translateNop},
		{ARM_INS_HLT, nullptr},
		{ARM_INS_HVC, nullptr},
		{ARM_INS_ISB, nullptr},
		{ARM_INS_LDA, nullptr},
		...
		{ARM_INS_MOVW, &Capstone2LlvmIrTranslatorArm_impl::translateMov},
		{ARM_INS_MRC, nullptr},
		...
		{ARM_INS_VACLE, nullptr},
		{ARM_INS_VACLT, nullptr},
		...
		{ARM_INS_VINS, nullptr},
		{ARM_INS_VJCVT, nullptr},
		...
		{ARM_INS_VLLDM, nullptr},
		{ARM_INS_VLSTM, nullptr},
		...
		{ARM_INS_VQRDMLAH, nullptr},
		{ARM_INS_VQRDMLSH, nullptr},
		...
		{ARM_INS_WFE, &Capstone2LlvmIrTranslatorArm_impl::translateNop},
		{ARM_INS_WFI, &Capstone2LlvmIrTranslatorArm_impl::translateNop},
		{ARM_INS_SEV, &Capstone2LlvmIrTranslatorArm_impl::translateNop},
		{ARM_INS_SEVL, &Capstone2LlvmIrTranslatorArm_impl::translateNop},
